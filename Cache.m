...
//  Eagle
//
//  Created by Kishon Daniels on 1/18/15.
...
- (void)setAttributesForPhoto:(PFObject *)photo likers:(NSArray *)likers commenters:(NSArray *)commenters likedByCurrentUser:(BOOL)likedByCurrentUser {
    NSDictionary *attributes = [NSDictionary dictionaryWithObjectsAndKeys:
                                [NSNumber numberWithBool:likedByCurrentUser],kPostAttributesIsLikedByCurrentUserKey,
...
- (NSNumber *)likeCountForPhoto:(PFObject *)photo {
    ...
    if (attributes) {
        return [attributes objectForKey:kPostAttributesLikeCountKey];
    }
...
- (NSNumber *)commentCountForPhoto:(PFObject *)photo {
    NSDictionary *attributes = [self attributesForPhoto:photo];
    if (attributes) {
        return [attributes objectForKey:kPostAttributesCommentCountKey];
    }
...
- (NSArray *)likersForPhoto:(PFObject *)photo {
    NSDictionary *attributes = [self attributesForPhoto:photo];
    if (attributes) {
        return [attributes objectForKey:kPostAttributesLikersKey];
    }
...
- (NSArray *)commentersForPhoto:(PFObject *)photo {
    NSDictionary *attributes = [self attributesForPhoto:photo];
    if (attributes) {
        return [attributes objectForKey:kPostAttributesCommentersKey];
    }
